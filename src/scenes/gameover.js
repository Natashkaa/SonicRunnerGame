...
export default function gameOver(){
    ...
    const rankValues = [50, 80, 10, 200, 300,400, 500];
    ...
    const bestRankBox = k.add([
        ...
        k.area(),
        k.anchor("center"),
        k.outline(6, k.Color.fromArray([20, 212, 42])),
        k.pos(k.center().x - 400, k.center().y + 50)
    ]);
    bestRankBox.add([
        k.text(bestRank, { font: "maina", size: 100 }),
        k.anchor("center")
    ]);
    ...
    const currentRankBox = k.add([
        ...
        k.area(),
        k.anchor("center"),
        k.outline(6, k.Color.fromArray([180,0,212])),
        k.pos(k.center().x + 400, k.center().y + 50)
    ]);
    currentRankBox.add([
